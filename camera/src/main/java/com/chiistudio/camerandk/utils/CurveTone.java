...
public class CurveTone {
    ...
    public void loadCurve(Context context, String path) {
    ...
    public ByteBuffer getCurveData() {
        ...
        ByteBuffer buffer = ByteBuffer.allocateDirect(toneCurveByteArray.length);
        for (Byte b : toneCurveByteArray) {
            buffer.put(b);
        }
        return buffer;
    }
