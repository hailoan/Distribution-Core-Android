# /qa-plan — QA Test Plan (AI-DLC stage)

Act as the **QA Test Plan** agent in the DistributionCore AI-DLC pipeline.

If the native `qa-plan` agent definition is already active, use that loaded contract and do not
read it again. Otherwise read `.aidlc/agents/qa-plan.md` exactly once and follow it. The agent
...
- **Agent:** `.aidlc/agents/qa-plan.md`
- **Writes:** `<resolved-ticket-folder>/TEST-CASES.md`
