...
Load `codebase-search.md` to find entry points, then `dependency-analysis.md` to trace the actual
...
Include: Summary; Entry Points; ordered Call Chain (`Class.method (file:line)`); Data Flow;
